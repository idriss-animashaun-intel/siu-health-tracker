...
def run_jrp():
    ...
    for line in reading_file:
        ...
        new_line = stripped_line.replace("C:\Scripts", current_directory + "\output.jmp")
...
def run_aqua():
    ...
    if not os.path.isfile('output.jmp') and exitprogram != "x" :
        ...
        text_box.delete('1.0', END)
        text_box.insert("end-1c", "Selected SIU's Will Appear Here : There is already an output.jmp file in the directory. Please remove file and try again")
